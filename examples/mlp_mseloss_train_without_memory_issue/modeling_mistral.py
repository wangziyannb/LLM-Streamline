...
class MistralModel(MistralPreTrainedModel):
    ...
    def __init__(self, config: MistralConfig):
        ...
        self.replace_layer = MistralMLP(config)  # The Lightweight Layer
    ...
    def forward(
        ...
        for decoder_layer in self.layers:
            ...
            if self.gradient_checkpointing and self.training:
                ...
                elif isinstance(decoder_layer, MistralMLP):
                    layer_outputs = (decoder_layer(hidden_states),)
                elif isinstance(decoder_layer, nn.ModuleList):
                    for replaced_decoder_layer in decoder_layer:
                        if output_hidden_states:
                            all_hidden_states += (hidden_states,)
                        layer_outputs = replaced_decoder_layer(
                            hidden_states,
                            attention_mask=attention_mask,
                            position_ids=position_ids,
